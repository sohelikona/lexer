...
bool validIdentifier(char* str) {
    if (str[0] == '0' || str[0] == '1' || str[0] == '2' || str[0] == '3' || str[0] == '4' || str[0] == '5' || str[0] == '6' || str[0] == '7' || str[0] == '8' || str[0] == '9' || isPunctuator(str[0]) == true)
    {
        return false;
    }
...
bool isNumber(char* str) {
    int i, len = strlen(str), numofDesimal = 0;
    if (len == 0) {
        return false;
    }
    for (i = 0; i < len; i++) {
        if (numofDesimal > 1 && str[i] == '.') {
            return false;
        } else if (numofDesimal <= 1) {
            numofDesimal++;
        }
